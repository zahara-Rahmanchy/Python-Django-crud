...
SECRET_KEY = "django-insecure-h(y@q-*@@)r%5i6c8)92!ynj1alh8#&83jwkb$0o3vq)uq%-aj"
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:5173',  # Replace with the port your frontend is running on
    'http://127.0.0.1:5173',  # Replace with the port your frontend is running on
    'http://localhost:5174',
    'http://127.0.0.1:5174',
]
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [BASE_DIR]  # Include the root directory as a static files directory
